...
namespace ClinicaPro.IngresoGastos
{
    public partial class frmListaMovimientos : Form
    {
        ...
        private void CambiarIcono()
        {
            if (this.cbIngresoOEgreso.SelectedIndex == Gasto)
            {
                if (pictureBox1.Image != ClinicaPro.Properties.Resources.minus_1)
                {
                    pictureBox1.Image = ClinicaPro.Properties.Resources.minus_1;
                }
            }
            else
            {
                if (pictureBox1.Image != ClinicaPro.Properties.Resources.add_1)
                {
                    pictureBox1.Image = ClinicaPro.Properties.Resources.add_1;
                }
            }
        }
        private void cargarcomboAno()
        {
            ...
            cbAño.DataSource = new ClinicaPro.DB.GastosIngresos.GastosDB().ListarAnosUsados(idTipoUsuario);
               ...
               cbAño.DataSource = new ClinicaPro.DB.GastosIngresos.IngresoDB().ListarAnosUsados(idTipoUsuario);
        }
        ...
        private void chk_Todo_CheckedChanged(object sender, EventArgs e)
        {
            ...
            {
                this.chk_Todo.BackgroundImage = global::ClinicaPro.Properties.Resources.switch_OFF;
                cbMes.Enabled = true;
                cbAño.Enabled = true;
            }
            else
            {
                this.chk_Todo.BackgroundImage = global::ClinicaPro.Properties.Resources.switch_ON;
                cbMes.Enabled = false;
                cbAño.Enabled = false;
            }
            cargarGrid(cbIngresoOEgreso.SelectedIndex);
