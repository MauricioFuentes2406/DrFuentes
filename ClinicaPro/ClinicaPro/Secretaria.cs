...
namespace ClinicaPro
{
    public partial class Secretaria : Form
    {
        ...
        {
            new ClinicaPro.Clientes.MantenimientoCliente(this._tipoUsuario).Show();
        }

        private void button4_Click(object sender, EventArgs e)
        {
            ClinicaPro.Citas.frmGeneralCitas frmCitas = new Citas.frmGeneralCitas(this._tipoUsuario);
            frmCitas.ShowDialog();
            frmCitas.Dispose();
        }
